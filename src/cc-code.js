...
function createButton(onClick) {
  ...
  button.type = 'button';
  button.className = 'cc-button-component cc-button-primary cc-button-xx-large cc-bg-primary cc-button-full centichess-button';
  ...
  button.innerHTML = `<br/>
    ...
    <span>Analyze in Centichess</span>
  `;
